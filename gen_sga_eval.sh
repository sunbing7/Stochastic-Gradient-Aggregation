...
CUDA_VISIBLE_DEVICES='0' python imagenet_eval.py --targeted=1 --dataset=cifar10 --target_class=0 --model_file_name=wideresnet_cifar10.pth --weight_path=/root/autodl-tmp/sunbing/workspace/uap/my_result/uap_virtual_data.pytorch/models/cifar10_wideresnet_123 --uaps_save=/root/autodl-tmp/sunbing/workspace/uap/my_result/sga/uap_save/sga --batch_size 100 --model_name wideresnet
